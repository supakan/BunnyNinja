...
public class Box {
    ...
    public Box(float x, float y, World world){
        ...
        shape.setAsBox(52 * TestScreen.M_PER_PIXEL/2, 52*TestScreen.M_PER_PIXEL/2);//size
    ...
    public void paint(Clock clock){
        blocks.setTranslation(
                (body.getPosition().x/TestScreen.M_PER_PIXEL)-26f,
                (body.getPosition().y/TestScreen.M_PER_PIXEL)-26f);
    }
    public Layer layer(){
        return this.blocks;
    }
