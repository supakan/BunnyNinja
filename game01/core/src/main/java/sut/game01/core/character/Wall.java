...
public class Wall {
    ...
    public Wall(final World world,final float x,final float y){
        sprite = SpriteLoader.getSprite("images/Wall.json");
    ...
    private Body initPhysicsBody(World world, float x, float y){
        ...
        shape.setAsBox(58* TestScreen.M_PER_PIXEL/2-0.68f,
