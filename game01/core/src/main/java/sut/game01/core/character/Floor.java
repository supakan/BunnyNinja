...
public class Floor {
    ...
    public Floor(final World world,final float x,final float y){
        sprite = SpriteLoader.getSprite("images/Floor.json");
    ...
    private Body initPhysicsBody(World world, float x, float y){
        ...
        shape.setAsBox(58* TestScreen.M_PER_PIXEL/2+0.3f,
